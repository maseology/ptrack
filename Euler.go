...
func (et *EulerTime) Track(p *Particle, q *Prism, w VelocityFielder) {
	vx, vy, vz := w.PointVelocity(p, q, 0.)
	p.X += vx * et.Dt
	p.Y += vy * et.Dt
	p.Z += vz * et.Dt
